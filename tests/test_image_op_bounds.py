...
async def test_migrating_a_circle_scales_its_radius_from_source_values(tmp_path) -> None:
    ...
    from custom_components.padspan_bright.model_store import ModelStore
    from custom_components.padspan_bright.ws_maps import ws_maps_delete_migrate
    from custom_components.padspan_bright.const import DOMAIN, DATA_MAPS, DATA_MODEL
