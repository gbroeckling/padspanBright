...
_WS_PY = Path(__file__).resolve().parents[1] / "custom_components" / "padspan_bright" / "const.py"
...
# floor) — pulled live via padspan_bright/model_get during the investigation of
