...
_EDITIONS = _ROOT / "custom_components" / "padspan_bright" / "www" / "padspan-bright" / "views" / "editions.js"
...
def test_only_a_version_shaped_string_is_stored() -> None:
    ...
    src = (_ROOT / "custom_components" / "padspan_bright" / "ws_settings.py").read_text(encoding="utf-8")
