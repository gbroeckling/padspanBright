...
from custom_components.padspan_bright.const import DOMAIN, DATA_SETTINGS
from custom_components.padspan_bright.presence_coordinator import PresenceCoordinator
...
def run_poll(coord: PresenceCoordinator, snap: dict[str, Any]) -> dict[str, Any]:
    ...
    with patch("custom_components.padspan_bright.websocket._live_snapshot", _snap), \
         patch("custom_components.padspan_bright.private_ble_resolver.get_resolver",
               _get_resolver):
