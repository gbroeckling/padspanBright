"""Unit tests for custom_components.padspan_bright.private_ble_resolver."""
...
from custom_components.padspan_bright.private_ble_resolver import (
    PrivateBLEResolver,
    _is_rpa,
    _parse_irk,
)
...
def test_the_resolution_cache_is_bounded() -> None:
    ...
    from custom_components.padspan_bright import private_ble_resolver as mod
