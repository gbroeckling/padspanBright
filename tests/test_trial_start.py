...
_CC = _ROOT / "custom_components" / "padspan_bright"
_VIEWS = _CC / "www" / "padspan-bright" / "views"
...
def test_trial_start_is_registered_and_admin_gated() -> None:
    ...
    assert '"type": "padspan_bright/trial_start"' in s, "the trial_start command is gone"
...
def test_licence_card_offers_the_trial_with_no_card_language() -> None:
    ...
    assert "padspan_bright/trial_start" in card, "the licence card cannot start a trial"
