...
from custom_components.padspan_bright import traceback_store as tb_mod
from custom_components.padspan_bright.traceback_store import TracebackStore
...
def test_history_records_metres_not_photo_fractions() -> None:
    ...
    from custom_components.padspan_bright import traceback_store
