...
async def test_ws_correct_room_resolves_the_stamp_server_side() -> None:
    ...
    from custom_components.padspan_bright.ws_fabric import ws_fabric_correct_room
...
async def test_reconcile_rewrites_the_stale_room_and_only_it() -> None:
    from custom_components.padspan_bright.ws_fabric import ws_fabric_rooms_reconcile
...
async def test_truth_candidates_reports_the_reconcilable_room() -> None:
    ...
    from custom_components.padspan_bright.ws_fabric import ws_fabric_truth_candidates
