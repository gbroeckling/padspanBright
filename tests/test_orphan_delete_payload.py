...
and push the WHOLE map back through `padspan_bright/maps_update`.  They used to
...
from custom_components.padspan_bright.const import DATA_MAPS, DOMAIN
from custom_components.padspan_bright.maps_store import MapsStore
from custom_components.padspan_bright.ws_maps import ws_maps_update
