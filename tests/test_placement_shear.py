...
from custom_components.padspan_bright import fabric_truth
...
class TestTheShearSignBackfill:
    ...
    async def test_it_recovers_the_sign_from_the_matrix(self) -> None:
        from custom_components.padspan_bright.migrations import _backfill_shear_sign
    ...
    def _fab(marker: list[str] | None = None):
        ...
        from custom_components.padspan_bright.migrations import MARKER
    ...
    async def test_the_migration_actually_runs_it(self) -> None:
        ...
        """
        from custom_components.padspan_bright.migrations import (
...
async def test_the_five_field_save_survives_the_endpoint_it_is_posted_to() -> None:
    """Save Scale posts to `padspan_bright/fabric_map_transform_set`, and not one
    ...
    from custom_components.padspan_bright.ws_fabric import ws_fabric_map_transform_set
