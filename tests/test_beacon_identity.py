...
from custom_components.padspan_bright.beacon_identity import (
    PERSIST_SPLIT_MIN,
    decide_split,
)
...
def test_a_bridge_needs_the_old_address_to_have_stopped() -> None:
    ...
    from custom_components.padspan_bright.beacon_identity import rotation_bridge_allowed
...
def test_a_shared_label_merges_only_on_a_shared_address() -> None:
    ...
    from custom_components.padspan_bright.beacon_identity import object_macs, same_device_by_address
...
from custom_components.padspan_bright.beacon_identity import (  # noqa: E402
    durable_addresses,
    memory_is_settled,
