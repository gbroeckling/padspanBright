...
def test_replaying_history_never_touches_a_lights_remembered_brightness():
    """A replayed frame overwrote padspan_bright_last_bri, so the next tap turned
...
""")
    ...
    src = (_ROOT / "custom_components" / "padspan_bright" / "www" / "padspan-bright" / "lights_panel.js").read_text(encoding="utf-8")
