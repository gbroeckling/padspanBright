...
from custom_components.padspan_bright.const import MAX_HEIGHT_M
from custom_components.padspan_bright.fabric_store import FabricStore
from custom_components.padspan_bright.model_store import (
...
def test_slant_projection() -> None:
    from custom_components.padspan_bright.presence_coordinator import _slant_to_horizontal
