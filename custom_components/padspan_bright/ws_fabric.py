...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_scanner_remove",
        "source": str,
    }
)
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_light_position_set",
        "entity_id": str,
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_light_remove",
        "entity_id": str,
    }
)
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_beacon_position_set",
        "key": str,
        "x_m": vol.Coerce(float),
        "y_m": vol.Coerce(float),
        vol.Optional("floor_id"): str,
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_beacon_remove",
        "key": str,
    }
)
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_room_add",
        "room": str,
        vol.Optional("floor_id"): str,
    }
)
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_room_remove",
        "room": str,
    }
)
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_sync_mode_set",
        "mode": str,
    }
)
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_scanner_position_set",
        "source": str,
        "x_m": float,
        "y_m": float,
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_floor_elevations_set",
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_correct_room",
        "floor_id": str,
        "room": str,
        "geometry": dict,
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_truth_candidates",
        "floor_id": str,
    }
)
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_rooms_reconcile",
        "floor_id": str,
    }
)
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_floor_finalize",
        "floor_id": str,
        "committed": bool,
    }
)
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_rf_barrier_set",
        "barrier": dict,
    }
)
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_rf_barrier_remove",
        "barrier_id": str,
    }
)
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/fabric_map_reanchor",
        "map_id": str,
...
@websocket_api.websocket_command({"type": "padspan_bright/fabric_health"})
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/fabric_resync"})
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/fabric_reset_spatial"})
@websocket_api.require_admin
@websocket_api.async_response
