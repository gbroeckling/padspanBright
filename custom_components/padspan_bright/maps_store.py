...
Data layout:
  - Metadata: .storage/padspan_bright.maps  →  {"maps": [MapDict, ...]}
  - Images:   www/padspan_bright/maps/{map_id}.png
...
class MapsStore:
    ...
    Images live on disk at www/padspan_bright/maps/{map_id}.png so HA's
    built-in static file server exposes them at /local/padspan_bright/maps/.
    Metadata lives in HA Storage (.storage/padspan_bright.maps).
    """
