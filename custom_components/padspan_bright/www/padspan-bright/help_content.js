...
// PadSpan Bright — User-facing help content
...
export const HELP = {
  ...
  settings_tiers: {
    ...
    body: [
      ...
      "PADSPAN PRO — Forensics (which Bluetooth devices were near a given scanner in any time window, with dwell time and CSV export) and light placement (fixture shapes and sizes, WLED, Showcase, Fit room) on a full PadSpan Bright install.",
