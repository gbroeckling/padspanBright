...
// views/training.js — PadSpan Bright Training Hub
...
<text x="200" y="182" text-anchor="middle" fill="#4a6052" font-size="9" font-family="system-ui">Use padspan_bright.dump_devices service to inspect full state</text>
</svg>`;
}
...
const MANUAL_SECTIONS = [
  ...
  },
  {
    ...
    icon: "🚀",
    paragraphs: [
      "1. Install PadSpan Bright via HACS as a custom repository. After adding the repository, install the integration and restart Home Assistant completely (not just reload — a full restart is required).",
      ...
      "4. Open PadSpan Bright from the sidebar. Use Sample mode first to familiarise yourself with the interface, then switch to Live mode to see your real devices.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "padspan_bright.dump_devices service — call this from HA Developer Tools → Services to get a full JSON snapshot of all tracked devices and their current state. Useful for debugging and building advanced templates. Returns response data compatible with scripts and automations.",
...
const QUICKSTART_SECTIONS = [
  ...
  },
  {
    ...
    icon: "🚀",
    paragraphs: [
      "1. Install PadSpan Bright via HACS (custom repository) and restart Home Assistant completely.",
      "2. Open PadSpan Bright from the sidebar. Use Sample mode first to explore the interface with demo data.",
...
function _renderManual(ctx, el, ts, HELP) {
  ...
  footer.appendChild(el("div", { style: "font-size:11px;color:#4a6052;line-height:1.6" },
    "Manual version: auto-generated from help_content.js. Content marked with a feature section heading reflects the current help text for that tab. To contribute corrections or additions, update help_content.js in the PadSpan Bright source."));
