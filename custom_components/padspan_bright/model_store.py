...
Data layout in .storage/padspan_bright.model:
  {
    ...
    "room_geometry_m": {...},         # RETIRED legacy copy — ground truth lives in
                                      # padspan_bright.fabric (FabricStore); kept on disk
...
DEFAULT_DATA: dict[str, Any] = {
    ...
    # live in FabricStore (padspan_bright.fabric) like room_geometry_m before them.
    ...
    "room_geometry_m": {
        # RETIRED — room shapes live in FabricStore (padspan_bright.fabric).
