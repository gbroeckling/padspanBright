...
"""
PadSpan Bright — Constants & Configuration Keys
=============================================
...
SETTINGS_STORE_KEY = "padspan_bright.settings"
MAPS_STORE_KEY = "padspan_bright.maps"
...
VENDOR_CACHE_STORE_KEY = "padspan_bright.vendor_cache"
TRACEBACK_STORE_KEY = "padspan_bright.traceback"
FORENSICS_STORE_KEY = "padspan_bright.forensics"
# Manifest only — session frames live in .storage/padspan_bright.capture_sessions/
CAPTURE_STORE_KEY = "padspan_bright.capture"
...
MAPS_DIR = "padspan_bright/maps"                   # relative to HA www/ dir → /local/padspan_bright/maps/
...
# ── Light marker shapes ─────────────────────────────────────────────────────
# The one backend copy of LIGHT_SHAPES in www/padspan-bright/views/light_codes.js —
