...
@websocket_api.websocket_command({"type": "padspan_bright/wled_devices"})
...
@websocket_api.websocket_command({"type": "padspan_bright/wled_get", vol.Required("path"): str, **_TARGET})
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/wled_state", vol.Required("body"): dict, **_TARGET})
@websocket_api.async_response
...
@websocket_api.websocket_command({
    "type": "padspan_bright/wled_backups",
...
@websocket_api.websocket_command({
    "type": "padspan_bright/wled_matrix",
...
@websocket_api.websocket_command({
    "type": "padspan_bright/wled_identify",
...
@websocket_api.websocket_command({"type": "padspan_bright/wled_live", **_TARGET})
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/wled_teams_get"})
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/wled_teams_set", vol.Required("teams"): list,
