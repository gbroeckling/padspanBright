...
"""
PadSpan Bright — Panel Registration
=================================
Registers exactly ONE HA sidebar panel (``padspan-bright``).  Internal navigation
...
STATIC_URL = "/padspan_bright_static"
ICON_STATIC_URL = "/padspan_bright_int"
WEB_COMPONENT        = "padspan-bright-app"
LIGHTS_WEB_COMPONENT = "padspan-bright-lights-app"
...
def _remove_panels(hass: HomeAssistant) -> None:
    ...
    try:
        ...
        async_remove_panel(hass, "padspan-bright")
        async_remove_panel(hass, "padspan-bright-lights")
    except Exception:
        pass
...
async def async_setup_panel(hass: HomeAssistant) -> None:
    ...
    # Also serve the integration root so icon.png is accessible at /padspan_bright_int/icon.png
    ...
    await _register_panel(
        ...
        frontend_url_path="padspan-bright",
        sidebar_title="PadSpan Bright",
        ...
        require_admin=False,
        module_url=f"{STATIC_URL}/padspan-bright/panel.js?v={VERSION}&b={ASSET_ID}&cb=full",
        config={
            "title": "PadSpan Bright",
            "icon": f"{STATIC_URL}/padspan-bright/assets/padspan-mark.svg",
            "logo": f"{STATIC_URL}/padspan-bright/assets/padspan-logo.svg",
            "version": VERSION,
        },
    )
    ...
    _LOGGER.info("PadSpan Bright panel registered v%s (build %s)", VERSION, BUILD_ID)
