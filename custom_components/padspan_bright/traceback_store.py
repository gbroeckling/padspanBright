...
(.storage/padspan_bright.traceback_segments/YYYYMMDD.jsonl).  Each 30 s flush
...
STORE_KEY = "padspan_bright.traceback"
SEGMENT_DIR = "padspan_bright.traceback_segments"
