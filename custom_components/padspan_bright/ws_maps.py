...
@websocket_api.websocket_command({"type": "padspan_bright/maps_list"})
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/maps_upload",
        "name": str,
        "filename": str,
        "mime": str,
        "width": int,
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/maps_update",
        "map_id": str,
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/maps_replace_image",
        "map_id": str,
        "width": int,
        "height": int,
        "png_base64": str,
...
@websocket_api.websocket_command({"type": "padspan_bright/maps_delete", "map_id": str})
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/maps_delete_migrate",
        "map_id": str,
        "target_map_id": str,
...
@websocket_api.websocket_command({"type": "padspan_bright/maps_revert_extend", "map_id": str})
@websocket_api.require_admin
@websocket_api.async_response
