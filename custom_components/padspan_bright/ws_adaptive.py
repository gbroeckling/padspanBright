...
@websocket_api.websocket_command({"type": "padspan_bright/adaptive_status_get"})
...
@websocket_api.websocket_command({"type": "padspan_bright/adaptive_fingerprints_get"})
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/adaptive_reset"})
@websocket_api.async_response
