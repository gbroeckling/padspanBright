...
@websocket_api.websocket_command({"type": "padspan_bright/auto_diagnostics"})
...
@websocket_api.websocket_command({"type": "padspan_bright/positioning_diag"})
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/propagation_health"})
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/system_critics"})
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/ha_entities_audit"})
@websocket_api.async_response
