...
"""Websocket handlers for the PadSpan Bright → PadSpan Bright import.
...
@websocket_api.websocket_command({"type": "padspan_bright/bright_import_status"})
...
@websocket_api.websocket_command({"type": "padspan_bright/bright_import"})
