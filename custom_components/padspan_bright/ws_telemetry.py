...
@websocket_api.websocket_command({"type": "padspan_bright/telemetry_preview"})
...
@websocket_api.websocket_command({
    "type": "padspan_bright/telemetry_event",
...
@websocket_api.websocket_command({"type": "padspan_bright/telemetry_send_now"})
...
@websocket_api.websocket_command({
    "type": "padspan_bright/install_base",
...
@websocket_api.websocket_command({"type": "padspan_bright/telemetry_reset_id"})
@websocket_api.require_admin
@websocket_api.async_response
