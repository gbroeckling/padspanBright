...
``.storage/padspan_bright.settings``.  Unknown keys from future versions are
...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    # padspan_bright.set_room_tag_map service / Manage UI.  Persisted here so it
    ...
    # Set only via the padspan_bright/forensics_license_activate command.
    "forensics_license_key": "",
    "forensics_license_expires": "",
    # True only for a key minted by padspan_bright/trial_start (the one-time 3-month
