...
"""
PadSpan Bright — Device Registry
===============================
...
Storage: ``.storage/padspan_bright.devices``
"""
...
DEVICE_REGISTRY_STORE_KEY = "padspan_bright.devices"
STORE_VERSION = 1
...
class DeviceRegistry:
    """Stable device identity registry for PadSpan Bright.
