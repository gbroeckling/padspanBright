...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/forensics_query",
...
@websocket_api.websocket_command({"type": "padspan_bright/forensics_license_reveal"})
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/forensics_license_activate",
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/trial_start",
...
@websocket_api.websocket_command({"type": "padspan_bright/forensics_stats"})
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/forensics_clear"})
@websocket_api.require_admin
@websocket_api.async_response
