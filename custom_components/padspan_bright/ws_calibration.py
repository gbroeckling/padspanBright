...
@websocket_api.websocket_command({"type": "padspan_bright/calibration_health_check"})
...
@websocket_api.websocket_command({"type": "padspan_bright/calibration_get"})
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/calibration_save_point",
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/calibration_delete_point",
        "point_id": str,
    }
)
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/calibration_clear"})
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/calibration_clear_map",
        "map_id": str,
    }
)
@websocket_api.require_admin
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/object_evict",
        "key": str,
    }
)
@websocket_api.require_admin
...
@websocket_api.websocket_command({"type": "padspan_bright/calibration_compute_model"})
@websocket_api.async_response
async def ws_calibration_compute_model(hass: HomeAssistant, connection, msg) -> None:
    ...
    try:
        ...
        _LOGGER.error("PadSpan Bright calibration_compute_model failed: %s", e)
        connection.send_error(msg["id"], "compute_failed", str(e))


@websocket_api.websocket_command({"type": "padspan_bright/calibration_retrain_rf"})
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/calibration_swap_radio",
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/calibration_relearn_radio",
...
async def ws_calibration_relearn_radio(hass: HomeAssistant, connection, msg) -> None:
    ...
    try:
        ...
        _LOGGER.warning("PadSpan Bright relearn model recompute failed: %s", e)
...
@websocket_api.websocket_command({"type": "padspan_bright/calibration_beacon_profiles"})
@websocket_api.async_response
async def ws_calibration_beacon_profiles(hass: HomeAssistant, connection, msg) -> None:
    ...
    try:
        ...
        _LOGGER.error("PadSpan Bright calibration_beacon_profiles failed: %s", e)
        connection.send_error(msg["id"], "compute_failed", str(e))
