...
@websocket_api.websocket_command({"type": "padspan_bright/private_ble_status"})
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/irk_validate",
        vol.Required("irk_hex"): str,
    }
)
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/irk_auto_detect"})
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/irk_remove",
        vol.Required("irk_hex"): str,
    }
)
@websocket_api.async_response
...
@websocket_api.websocket_command({
    "type": "padspan_bright/private_ble_add_irk",
...
@websocket_api.websocket_command({
    "type": "padspan_bright/private_ble_delete_irk",
