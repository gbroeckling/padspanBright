...
@websocket_api.websocket_command({
    "type": "padspan_bright/factory_reset",
    vol.Required("confirm"): str,
})
@websocket_api.require_admin
@websocket_api.async_response
async def ws_factory_reset(hass: HomeAssistant, connection, msg) -> None:
    """Erase every PadSpan Bright persistent store and reset to factory defaults.
    ...
    try:
        ...
        if maps_obj and hasattr(maps_obj, "maps_dir"):
            ...
            _mdir = _Path(hass.config.path("www")) / "padspan_bright" / "maps"
    ...
    try:
        ...
        errors.append("padspan_bright.capture")
