...
@websocket_api.websocket_command({
    "type": "padspan_bright/scanner_offset_set",
    "source": str,
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/radio_area_set",
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/radio_lost_set",
        "source": str,
        "lost": bool,
    }
)
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/radio_disabled_set",
        "source": str,
        "disabled": bool,
    }
)
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/radio_reset",
        "source": str,
    }
)
...
@websocket_api.websocket_command({"type": "padspan_bright/radio_audit"})
@websocket_api.async_response
