...
@websocket_api.websocket_command({"type": "padspan_bright/device_registry_list"})
...
@websocket_api.websocket_command({"type": "padspan_bright/device_registry_migrate"})
@websocket_api.async_response
...
@websocket_api.websocket_command({
    "type": "padspan_bright/device_registry_merge",
    "keep_id": str,
    "absorb_id": str,
})
@websocket_api.async_response
...
@websocket_api.websocket_command({
    "type": "padspan_bright/device_registry_label_set",
    "padspan_id": str,
    "label": str,
})
@websocket_api.async_response
...
@websocket_api.websocket_command({
    "type": "padspan_bright/device_registry_add_identity",
    "padspan_id": str,
    "kind": str,
    "value": str,
})
...
@websocket_api.websocket_command({
    "type": "padspan_bright/device_registry_delete",
    "padspan_id": str,
})
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/espresense_companion_import"})
