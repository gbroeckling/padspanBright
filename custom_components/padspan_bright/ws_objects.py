...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/object_label_set",
        "address": str,
        "label": str,
    }
)
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/object_label_delete",
        "address": str,
    }
)
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/object_label_list"})
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/findmy_unlink", "key": str, vol.Optional("address"): str})
@websocket_api.async_response
...
@websocket_api.websocket_command({"type": "padspan_bright/objects_clear_history"})
@websocket_api.async_response
