...
"""PadSpan Bright → PadSpan Bright: the house someone built in Bright, once.
...
next to this install's `.storage/padspan_bright.X`. Someone who mapped their
whole house in Bright and then installed PadSpan Bright would otherwise start
...
user's step, taken when they can see the house standing in PadSpan Bright.
