...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/capture_start",
...
@websocket_api.websocket_command({"type": "padspan_bright/capture_stop"})
@websocket_api.require_admin
@websocket_api.async_response
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/capture_mark",
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/capture_get",
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/capture_delete",
        vol.Required("session_id"): str,
    }
)
@websocket_api.require_admin
...
@websocket_api.websocket_command(
    {
        "type": "padspan_bright/capture_replay",
        vol.Required("session_id"): str,
